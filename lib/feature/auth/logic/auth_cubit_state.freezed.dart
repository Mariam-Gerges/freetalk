...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AuthCubitState<T>);
}
...
/// @nodoc
class $AuthCubitStateCopyWith<T,$Res>  {
$AuthCubitStateCopyWith(AuthCubitState<T> _, $Res Function(AuthCubitState<T>) __);
}


/// Adds pattern-matching-related methods to [AuthCubitState].
extension AuthCubitStatePatterns<T> on AuthCubitState<T> {
...
class _Initial<T> implements AuthCubitState<T> {
  const _Initial();
...
class _Loading<T> implements AuthCubitState<T> {
  const _Loading();
...
class _Success<T> implements AuthCubitState<T> {
...
/// @nodoc
abstract mixin class _$SuccessCopyWith<T,$Res> implements $AuthCubitStateCopyWith<T, $Res> {
...
class _Failure<T> implements AuthCubitState<T> {
...
@override
String toString() {
  return 'AuthCubitState<$T>.failure(error: $error)';
}
...
/// @nodoc
abstract mixin class _$FailureCopyWith<T,$Res> implements $AuthCubitStateCopyWith<T, $Res> {
